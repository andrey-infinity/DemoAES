...
namespace DemoAES
{
    class ProcessAES 
    {
        ...
        {
            set { _state = value;
            OnViewState(new ViewStateArgs(state));
        }
            get { return _state; }
        ...
        public ProcessAES(MainForm.ViewEventHandler _ViewStateEvent, MainForm.EndThreadEventHandler _EndStateEvent)
        {            
            this.ViewStateEvent = _ViewStateEvent;
            this.EndStateEvent = _EndStateEvent;
        }

        #region Event ViewState
        public event MainForm.ViewEventHandler ViewStateEvent;
        public event MainForm.EndThreadEventHandler EndStateEvent;
        protected virtual void OnViewState(ViewStateArgs e)
        {
            if (ViewStateEvent != null)
                ViewStateEvent(this, e);
        }
